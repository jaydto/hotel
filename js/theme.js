...
(function($) {
	...
	*/
	var $noticeTopBar = {
		...
		init: function() {
			...
			if( !$.cookie('JaydNoticeTopBarClose') ) {
				self
					.build()
					.events();
			} else {
		...
		saveCookie: function() {
			...
			$.cookie('JaydNoticeTopBarClose', true);
	...
	* Toggle Class
	*/
	$('[data-Jayd-toggle-class]').on('click', function (e) {
		e.preventDefault();

		$(this).toggleClass( $(this).data('Jayd-toggle-class') );
	});
...
(function(theme, $) {
	...
	PluginGDPR.prototype = {
		...
		build: function() {
			...
			if( $.cookie( 'Jayd-gdpr-preferences' ) ) {
				var preferencesArr = $.cookie( 'Jayd-gdpr-preferences' ).split(',');
				...
				setTimeout(function(){
					...
					setTimeout(function(){
						...
						if( $.cookie( 'Jayd-gdpr-preferences' ) ) {
							...
							$.cookie( 'Jayd-gdpr-preferences', formData );
							location.reload();
		...
		clearCookies: function() {
			...
			$.removeCookie( 'Jayd-privacy-bar' );
			$.removeCookie( 'Jayd-gdpr-preferences' );
...
(function(theme, $) {
	...
	PluginGDPRWrapper.prototype = {
		...
		build: function() {
			...
			if( $.cookie( 'Jayd-gdpr-preferences' ) && $.cookie( 'Jayd-gdpr-preferences' ).indexOf( self.options.checkCookie ) != -1 ) {
